...
namespace Code_Based_Test_4
{
    ...
    class QuestionThree
    {
            ...
            List<Employee> empList = new List<Employee>
        {
            ...
            Console.WriteLine("1. Details of all employees: ");
